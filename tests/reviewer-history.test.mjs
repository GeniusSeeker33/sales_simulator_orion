...
test("scoped reviewer authorization against all applied migrations", async t => {
  ...
  try {
    ...
    for (const file of ["20260905170811_durable_learner_records.sql","20260905175922_scoped_reviewer_history.sql","20260905181617_attributable_coaching_sessions.sql","20260905191217_human_reviewed_competency_evidence.sql","20260905192514_human_approved_competency_band_review.sql"]) {
